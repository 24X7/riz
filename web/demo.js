...
(function () {
  ...
  var SEQ = [
    { c: "cmt", t: "# orders.ts — a plain handler" },
    { c: "code", t: "export const handler = (e) => order(e.pathParameters.id)" },
    { c: "gap" },
    { c: "cmd", t: "riz run" },
    { c: "out", t: "  ▸ orders ready · MCP at /_riz/mcp" },
    { c: "gap" },
    { c: "cmd", t: "curl :3000/orders/1042" },
    { c: "out", t: '  {"id":"1042","total":4299}' },
    { c: "gap" },
    { c: "cmd", t: "claude mcp add riz …/_riz/mcp" },
    { c: "out", t: "  ✓ riz · 1 tool: get_order" },
    { c: "gap" },
    { c: "agent", t: 'agent ▸ get_order {"id":"1042"}' },
    { c: "out", t: '  ← {"id":"1042","total":4299}' },
  ];
